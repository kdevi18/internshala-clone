...
const index = () => {
  ...
  useEffect(()=>{
    const fetchdata=async()=>{
      try {
        const res=await axios.get( `https://internshala-clone-git-main-komaladevis-projects.vercel.app/api/internship/${id}`)     
  ...
  const handlesubmitapplication=async()=>{
    ...
    try {
      ...
      await axios.post("https://internshala-clone-git-main-komaladevis-projects.vercel.app//api/application",applicationdata)
